...
export function createRememberTool(memory: MemoryAPI): Tool {
  return {
    name: 'remember_fact',
    description: 'Store an important fact or learning for recall in future sessions. Use for: project conventions, codebase patterns, user preferences, key decisions.',
    inputSchema: {
      type: 'object',
      properties: {
