...
export class InjectionScanner {
	public scan(content: string, source: string): ScanResult {
		...
		const instructionOverrideRegex =
			/ignore previous instructions|you are now|forget everything|disregard|new instructions:|system:|IMPORTANT:\s*override/i;
		const roleInjectionRegex =
			/<\|system\|>|<\|assistant\|>|\[INST\]|### System:|Human:|Assistant:/i;
